...
import com.xworkz.collectionapp.DTO.WeaponDTO;
import com.xworkz.collectionapp.constant.Type;
...
public class WeaponDTOTester {
		...
		public static void main(String[] args) {
			...
			collection.add(new WeaponDTO("cannon", "sangeetha", "Jan" , 9999.00, Type.French75));
			collection.add(new WeaponDTO("catapult", "anu", "Feb" , 129999.00, Type.onager));
			collection.add(new WeaponDTO("bomb", "nandi", "March" , 135678.00, Type.atomicbomb));
			collection.add(new WeaponDTO("thermonuclear bomb", "Supritha", "April" , 799999.00, Type.neutronbomb));
			collection.add(new WeaponDTO("arrow", "aishu", "May" , 9876639.00, Type.crossbow));
			collection.add(new WeaponDTO("carbine", "Anusha", "June" , 97639.00, Type.SpencerCarbine));
			collection.add(new WeaponDTO("handgun", "ganesha", "July" , 12467.00, Type.derringer));
			collection.add(new WeaponDTO("rifle", "shalini", "Aug" , 967543.00, Type.DreyseRifle));
			collection.add(new WeaponDTO("pistol", "anushree", "Sep" , 999999.00, Type.LugerPistol));
			collection.add(new WeaponDTO("assault ", "chethu", "Oct" ,12399.00, Type.AK47));
			collection.add(new WeaponDTO("gun", "Shivu", "Nov" , 6555499.00, Type.MG42));
			collection.add(new WeaponDTO("submachine gun", "hema", "Dec" , 432399.00, Type.SteGun));
