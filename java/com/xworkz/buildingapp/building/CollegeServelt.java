package com.xworkz.buildingapp.building;
...
import javax.servlet.http.HttpServletResponse;
	...
	@WebServlet(loadOnStartup = 3,urlPatterns = "/ravi")
	public class CollegeServelt extends HttpServlet {

		public CollegeServelt() {
		...
		protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
			...
			+BranchName4+" "+BranchName5+ " "+BranchName6+" "+NoOfBranches+" "+HodName+" "+PrincipleName+" "+PhoneName+" "+SubjectName+" "+NoOfStudent+" "+NoOfSubject);
		}
	}
